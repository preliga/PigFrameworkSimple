    ...
    <div>
        <div class="container">
            <div class="well well-sm">
                <form action="/admin/repertoire/editshow?showId={$show['id']}" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="movieId" class="form-control" required="required">
                                    ...
                                    {foreach $movies as $movie}
                                        <option value="{$movie['id']}" {if $movie['id'] == $show['movieId']} selected {/if}>{$movie['title']}</option>
                                    {/foreach}
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datetimepicker" name="term" required="required" value="{$show['term']}"/>
                            </div>
                        </div>
                        <div class="col-md-12">
